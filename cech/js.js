...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('map')) {
       ...
       var points = [
            { lat: 50.3890, lng: 14.2893, title: "Místo původu základního kamene Národního divadla", desc: "Z tohoto místa na hoře Říp pochází jeden z devatenácti základních kamenů národního divadla." },
            { lat: 50.3864, lng: 14.2895, title: "Rotunda sv. Jiří", desc: "Románská rotunda, která na vrcholu hory stojí jako symbol češství." },
            { lat: 50.3841, lng: 14.2887, title: "Pražská vyhlídka", desc: "Odtud prý Praotec přehlížel krajinu směrem k jihu." },
            { lat: 50.3879, lng: 14.2921, title: "Mělnická vyhlídka", desc: "Pohled na Polabí a soutok Labe s Vltavou." }
        ];
