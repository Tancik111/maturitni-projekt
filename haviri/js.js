...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('map')) {
        ...
        }).setView([49.9474472, 15.2653064], 15);
        ...
        var points = [
            { lat: 49.9449361, lng: 15.2635931, title: "Chrám sv. Barbory", desc: "Patronka havířů shlíží na město stříbra." },
            { lat: 49.9462911, lng: 15.2649394, title: "Důl Osel", desc: "Jeden z nejhlubších a nejslavnějších středověkých dolů." },
            { lat: 49.9474472, lng: 15.2653064, title: "Hrádek - České muzeum stříbra", desc: "Vstup do historického podzemí, kde pracovali havíři." },
            { lat: 49.9483333, lng: 15.2686117, title: "Vlašský dvůr", desc: "Místo, kde se razily pražské groše z vytěženého stříbra." }
        ];
