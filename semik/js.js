...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('map')) {
        ...
        }).setView([50.0635039, 14.4160431], 15);
...
var points = [
    {
        lat: 50.0635039, lng: 14.4160431,
        title: "Vyšehradská skála",
        desc: "Místo osudného odrazu, kde se Šemíkova kopyta naposledy dotkla země před skokem do hlubiny."
    },
    {
        lat: 50.0617092, lng: 14.4241697,
        title: "Táborská brána",
        desc: "Nejpravděpodobnější vstup na Vyšehrad, kudy mohl Horymír v doprovodu stráží vjet na svou poslední jízdu před skokem."
    },
    {
        lat: 50.0622753, lng: 14.4211456,
        title: "Vyšehradské sady",
        desc: "Prostor bájného knížecího dvorce, kde Horymír vyslechl svůj rozsudek smrti a požádal o poslední jízdu na svém koni."
    },
    {
        lat: 50.0687486, lng: 14.4143628,
        title: "Podskalí (náplavka pod Vyšehradem)",
        desc: "Místo na břehu Vltavy, kde vyčerpaný Šemík s Horymírem na hřbetě vyplaval z ledové vody zpět na pevnou zem."
    }
];
