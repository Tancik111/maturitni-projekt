...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('map')) {
        ...
        var points = [
            { lat: 49.6445, lng: 14.870, title: "Velký Blaník", desc: "Hora, v jejímž nitru prý odpočívá svatováclavské vojsko." },
            { lat: 49.648, lng: 14.8665, title: "Veřejová skála", desc: "Mýtický vstup do hory, který se otevírá jen v nejhorších chvílích." },
            { lat: 49.6420, lng: 14.873, title: "Rozhledna Blaník", desc: "Dřevěná rozhledna nabízející pohled na krajinu blanických rytířů." },
            { lat: 49.6450, lng: 14.8600, title: "Louňovice pod Blaníkem", desc: "Výchozí bod výprav k hoře opředené pověstmi." }
        ];
