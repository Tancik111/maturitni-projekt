...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('map')) {
        ...
        var points = [
            { lat: 50.1915, lng: 14.2454, title: "Hradiště Budeč", desc: "Dávné sídlo knížete Kroka a centrum vzdělanosti." },
            { lat: 50.1912, lng: 14.2448, title: "Rotunda sv. Petra a Pavla", desc: "Nejstarší stojící stavba v ČR, postavená na místě původního hradiště." },
            { lat: 50.1908, lng: 14.2459, title: "Vyhlídka Budeč", desc: "Vyhlídka na Kováry a údolí Zákolanského potoka." },
            { lat: 50.1913, lng: 14.2448, title: "Krokovy sady", desc: "Okolní příroda spojená s mýtickou školou moudrosti." }
        ];
