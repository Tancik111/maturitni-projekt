...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('map')) {
        ...
        }).setView([50.086655, 14.4093283], 15);
        ...
        var points = [
            { lat: 50.0866558, lng: 14.4093283, title: "Socha Bruncvíka", desc: "U Karlova mostu stojí Bruncvík se svým magickým mečem a lvem." },
            { lat: 50.0910139, lng: 14.4008772, title: "Katedrála sv. Víta", desc: "Zde má být podle legendy zazděn Bruncvíkův zázračný meč." },
            { lat: 50.0906203, lng: 14.4017456, title: "Starý královský palác", desc: "Tradiční sídlo českých panovníků spojené s Bruncvíkovým návratem." },
            { lat: 50.0865344, lng: 14.4109558, title: "Karlův most", desc: "Místo spojené s hrdinstvím Bruncvíka a ochranou země." }
        ];
